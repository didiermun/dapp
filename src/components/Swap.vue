            ...
            <div class="flex flex-col gap-6">
               ...
               <div class="flex justify-between">
                   ...
                   <svg class="cursor-pointer" width="22" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12 14H14.725C13.8753 15.223 12.657 16.1426 11.2478 16.6245C9.83871 17.1063 8.31247 17.1254 6.89176 16.6788C5.47105 16.2322 4.2302 15.3434 3.35021 14.1419C2.47023 12.9404 1.99716 11.4892 2 10H9.55917e-07C-0.00085677 11.8615 0.575521 13.6775 1.64974 15.1978C2.72395 16.718 4.24315 17.8678 5.99805 18.4887C7.75295 19.1096 9.6572 19.1711 11.4485 18.6647C13.2398 18.1583 14.83 17.1088 16 15.661V18H18V12H12V14Z" fill="white"/>
                    </svg>
                    </div>
                    <div class="flex gap-2 cursor-pointer">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12 6H10V10H6V12H10V16H12V12H16V10H12V6Z" fill="white"/>
                        </svg>
